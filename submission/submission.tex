...
\paragraph{Second:} Provide a variant. EquiDafny provides a suitable variant (\lstinline|count|), copied from the \lstinline|InsertSorted1| function.
...
\section{Evaluation}
To evaluate EquiDafny, I took the set of program equivalence tests from Stainless and converted them to Dafny. I additionally created a few new tests myself. This dataset is at \url{https://github.com/NVictor2004/dafny-equivalence-benchmarks}. The results are shown below. Thus, EquiDafny improves the base Dafny verifier and is almost on par to the state-of-the-art checker Stainless. 
\begin{center}
