...
\paragraph{Second:} Provide a variant. EquiDafny provides a suitable variant for proving termination (\lstinline|count|), copied from the \lstinline|InsertSorted| functions.
