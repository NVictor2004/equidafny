...
double snippet (double x ) {
    ...
    double pi2_lo2 = longBitsToDoubleC((long)0xB91F1976B7ED8FBCL);
    double _2_pi_lo = longBitsToDoubleC((long)0xBC86B01EC5417056L);
    double pi2_hi_hi = longBitsToDoubleC((long)0xFC000000L);
    double pi2_hi_lo = pi2_hi - pi2_hi_hi;
    double pi2_lo_hi = longBitsToDoubleC((long)0xFC000000L);
    ...
    long l_x = doubleToRawLongBits(x);
