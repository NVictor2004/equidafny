...
case class Function(name: String, generic: Option[List[(String, Option[GOption])]], params: List[Parameter], returnType: Type, specs: List[Spec], body: ExprBlock) extends TopLevel
object Function extends PureParserBridge6[String, Option[List[(String, Option[GOption])]], List[Parameter], Type, List[Spec], ExprBlock, Function]
case class GhostFunction(name: String, generic: Option[List[(String, Option[GOption])]], params: List[Parameter], returnType: Type, specs: List[Spec], body: ExprBlock) extends TopLevel
object GhostFunction extends PureParserBridge6[String, Option[List[(String, Option[GOption])]], List[Parameter], Type, List[Spec], ExprBlock, GhostFunction]
