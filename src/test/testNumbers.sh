...
eqBenchExclude=("auxiliaryLemmas" "auxiliaryLemmasAssumption" "auxiliaryLemmasAssumptionTermination" "terminationAuxiliaryLemmas" "terminationAuxiliaryLemmasInduction" "terminationHelperEquivalenceAuxiliaryLemmas" "assumption" "helperEquivalenceVarinlining" "matchflattening" "varinlining")
