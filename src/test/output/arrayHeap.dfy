...
{{var l := leftM(i);var r := rightM(i);if ((l < N) && (r < N)){isHeapM_isHeap_Equivalence(a, N, l);isHeapM_isHeap_Equivalence(a, N, r);}else {if (l < N){isHeapM_isHeap_Equivalence(a, N, l);}else {}}}}
