...
{{var l := leftM(i);var r := rightM(i);match ((l < N) && (r < N)) {
case false =>match (l < N) {
case false =>
case true =>isHeapM_isHeap_Equivalence(a, N, l);
}

case true =>isHeapM_isHeap_Equivalence(a, N, l);isHeapM_isHeap_Equivalence(a, N, r);
}
}}
