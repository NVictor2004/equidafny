...
{unique(lst, Nil)}function uniqA(lst :List<int>): List<int>
{distinct(Nil, lst)}function distinct(a :List<int>, b :List<int>): List<int>
decreases b
{match b {
case Nil => a
...
}lemma uniqAEquivalence(lst :List<int>)
