...
The majority of the following examples have been taken from the program equivalence tests in the GitHub repository for the Stainless Scala verification tool \textcite{StainlessFrontendsBenchmarks}. The following table summarises the number of tests that demonstrate each type of limitation, after converting them into Dafny and proving their equivalence: 
