...
\end{lstlisting}
%
The main difficulty with proving the equivalence of these two functions is that they approach the problem in opposite ways: the first function processes the list from the end to the start, while the second processes
it from the start to the end. However, despite this, Dafny is able to prove equivalence with almost no help from the user:
