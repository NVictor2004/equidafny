...
\footnote{short paragraph intro to each sub section, maybe copy from plans?}
...
\footnote{Where does the limitation truly lie, any patterns to what it can/cannot prove?}
