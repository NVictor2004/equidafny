...
\footnote{technical audit can go in the background}
\footnote{also look at broken / incorrect examples and see equivalence, they should be}
\footnote{change first example to be more impressive, tail recursion?, more intentional differences, rather than moving things around; use the max example, approaching list from both ends}

\footnote{describe how lemmas in Dafny work}

\footnote{comparing Lists and seqs, wrong examples}
