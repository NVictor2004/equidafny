...
\footnote{split implementation into design (the algorithm) and implementation (the choice of languages, scala parsley, formatting, translation), just rearrange}
