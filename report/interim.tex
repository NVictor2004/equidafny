...
The user must also explicitly call these helper lemmas, with the correct arguments, within the main equivalence lemma (as demonstrated above). Sometimes, these helper lemmas can only be called when specific conditions are met.
TODO is the above example sufficient?

This will be difficult to do if we use the process described above, since the helper lemmas will only be generated after the user has finished writing. 
