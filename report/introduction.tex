...
\footnote{SD: better justification for the Fields, N: are these better?}
\footnote{add citations throughout or drop if no evidence found}
...
\footnote{general aim is to learn from the best and build a tool that takes the best bits and combines them}
\footnote{tone down aim, fully auto to little help as possible}
